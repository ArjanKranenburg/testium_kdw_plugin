...
public class KeywordDefinitionsWriterImpl implements KeywordDefinitionsWriter {
	...
	public KeywordDefinitionsWriterImpl(KeywordDefinitionsConfiguration kdwConfig) {
		config = kdwConfig;
	}
...
//			cmdFileWriter.write("  <Example>\n");
//			cmdFileWriter.write("    <teststep>\n");
//			String interfaceName = ifTargetDir.getName();
//			cmdFileWriter.write("      <command interface='" + interfaceName + "'>" + command + "</command>\n");
//			cmdFileWriter.write("      </command>\n");
//			cmdFileWriter.write("    </teststep>\n");
//			cmdFileWriter.write("  </Example>\n");
			cmdFileWriter.write("</TestStepDefinitions>\n");
			cmdFileWriter.flush();
